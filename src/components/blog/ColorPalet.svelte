...
<div class='dropdown dropdown-left dropdown-center'>
    <div tabindex="0" role="button" class='flex h-8 w-8 items-center justify-center rounded-lg drop-shadow-[0px_1.5px_1.5px_rgba(0,0,0,0.175)] hover:text-accent-two'>
    ...
    <div class='dropdown-content mt-3  rounded-3xl flex flex-col items-end p-2 gap-3 w-40 mr-5'>
