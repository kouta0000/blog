...
<div class='dropdown dropdown-end'>
    ...
    <div class='dropdown-content mt-3 bg-base/20 flex flex-col items-end p-2 gap-3'>
        <input class="range" type="range" min="0" max="360" bind:value={hue} oninput={updatehue} />
        <button class='btn btn-outline btn-base btn-xs ' onclick={initialize}>初期化</button>
    </div>
</div>